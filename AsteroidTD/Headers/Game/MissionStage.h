...
public:
    ...
    CourierStage(void * courier_objective, std::wstring mission_type) : objective(courier_objective), MissionStage(courier) {
        ...
        current_description = buffer[rand() * buffer.size() / (RAND_MAX)];
        ...
        short_description = buffer[rand() * buffer.size() / (RAND_MAX)];
        ...
        broad_description = buffer[rand() * buffer.size() / (RAND_MAX)];
    }
...
public:
    DefenceStage(void * objective, DefenceInfo info, int mission_level) : objective(objective), MissionStage(defence) {
        ...
        cur_desc_search = buffer[rand() * buffer.size() / (RAND_MAX)];
        ...
        cur_desc_ready = buffer[rand() * buffer.size() / (RAND_MAX)];
        ...
        cur_desc_wave_start = buffer[rand() * buffer.size() / (RAND_MAX)];
        ...
        cur_desc_wave_active = buffer[rand() * buffer.size() / (RAND_MAX)];
        ...
        cur_desc_finished = buffer[rand() * buffer.size() / (RAND_MAX)];
    }
